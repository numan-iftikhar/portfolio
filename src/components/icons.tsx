...
/**
 * Brand logos. lucide-react removed brand icons for trademark reasons,
 * so we provide our own simple-icons-style SVGs with the same API
 * (accepts className, etc.) as lucide icons.
 */
